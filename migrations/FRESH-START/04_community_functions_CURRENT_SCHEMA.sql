-- ============================================
-- COMMUNITY FUNCTIONS - FÜR AKTUELLES SCHEMA
-- ============================================
-- Arbeitet mit separater anlagen_freigaben Tabelle
-- (nicht mit FRESH-START Schema wo Freigaben in anlagen Tabelle sind)
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Hinweis: Arbeitet mit separater anlagen_freigaben Tabelle';
END $$;
