...
> ### Abgabe an Dritte — der dritte Weg (seit 05.09.2026)
>
> **Gibst du Strom an andere ab** — Mieterstrom, Allgemeinstrom, ein Nachbarhaus —, dann kennt eedc dafür jetzt einen eigenen Weg. Hinter deinem Hausanschluss wird eine Kilowattstunde auf **drei** Arten los: Du verbrauchst sie selbst, du speist sie ins Netz ein, oder du gibst sie an Dritte ab. Für den dritten Weg gibt es unter *Sonstiges* die Kategorie **„Abgabe an Dritte"** mit dem Feld **„Abgabe (kWh)"** — das ist der **Zähler an der Übergabestelle**, kumulativ oder als Tagessensor. eedc zieht diese Menge vom Eigenverbrauch ab; sie zählt weder als Eigenverbrauch noch als Netz-Einspeisung. Autarkie, Eigenverbrauchsquote, Eigenverbrauchs-Ersparnis und CO₂ folgen daraus — und die Zeile **„Abgabe an Dritte"** steht in Cockpit → Monat/Jahr, im Cockpit-Block *Sonstiges – Abgabe an Dritte* und in den Berichten. Der **Erlös** bleibt dein Feld **„Erlös (€)"**; die Abrechnung an die Abnehmer ist nicht Sache von eedc.
>
> ⚑ **Hattest du das Gerät bisher als *Erzeuger* angelegt** (mit Einspeise-Zähler und Erlös), stellst du die Kategorie um und ordnest den Zähler als „Abgabe" zu — eedc verschiebt nichts von allein. Der Daten-Checker weist auf Erzeuger hin, die so aussehen.
>
> ### ⛔ Was eedc bei Abgabe an Dritte weiterhin nicht kann
>
> **Ohne Zähler an der Übergabestelle gibt es keine Abgabe** — eedc schätzt keinen Anteil. Versorgt dieselbe Anlage dein Haus und die Abnehmer, ohne dass die Übergabe gemessen wird, bleibt es bei der bisherigen Grenze: Was du abgegeben hast, erscheint dann als dein Eigenverbrauch, und welcher Anteil überhaupt wo zählt, entscheidet dein Messkonzept, nicht eedc. Eine zweite Anlage ist nur dann der richtige Weg, wenn der Erzeuger einen wirklich getrennten Zählpunkt hat und deinen Haushalt gar nicht versorgt.
