...
> **Was die Vorschau prüft — und was sie nicht prüft.** Sie stellt deine gespeicherten **Zählerstände** den Werten aus der Home-Assistant-Statistik gegenüber. Meldet sie „keine Änderung", heißt das genau das: An den Zählerständen ändert der Lauf nichts. Es heißt **nicht**, dass der Lauf folgenlos bliebe — die **Stundenwerte** und die **Tageszusammenfassung** baut er aus diesen Zählerständen in jedem Fall neu auf, und darauf schaut die Vorschau nicht. Genau das ist der häufigste Grund, sie zu starten: Wenn die Aggregation einmal ausgesetzt hat, stehen die Zählerstände vollständig da, und trotzdem fehlen dir Stunden. Deshalb nennt die Vorschau zusätzlich, **wie viele der 24 Stunden** für den Tag gespeichert sind — steht dort weniger als 24, trägt der Lauf die fehlenden nach.
